...
* **Prévisualisation Native** : Rendu en direct identique à Anki (supporte les balises conditionnelles `{{#Champ}}` et MathJax/LaTeX).
* **Navigateur de Base de Données** : Éditez, filtrez et organisez vos cartes générées avant de les exporter.
