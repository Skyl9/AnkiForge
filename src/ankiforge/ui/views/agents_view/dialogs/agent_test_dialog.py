...
class AgentTestDialog(QDialog):
    ...
    def __init__(self, persona: PersonaModel, ai_manager: Any | None = None, parent: QWidget | None = None) -> None:
        ...
        self.output_text.setStyleSheet(
            f"background: {DesignTokens.BG_INPUT}; border: 1px solid {DesignTokens.BORDER_COLOR}; color: {DesignTokens.SYNTAX_TAG}; font-family: '{DesignTokens.FONT_CODE}'; font-size: 12px;"
        )
