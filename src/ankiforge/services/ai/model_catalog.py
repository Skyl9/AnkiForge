...
CURATED_MODELS: dict[str, ModelSpec] = {
    ...
    # ── OPENCODE ZEN (Modèles vérifiés) ──
    "opencode:deepseek-v4-flash": ModelSpec(
        provider="opencode",
        model_id="deepseek-v4-flash",
        display_name="DeepSeek V4 Flash (OpenCode)",
        context_window=128000,
        max_tokens=16384,
        supports_vision=True,
        supports_thinking=False,
        ...
        ankiforge_use_case="Le modèle phare et économique de la passerelle OpenCode : idéal pour formuler des cartes d'une grande rigueur syntaxique.",
        description="Architecture DeepSeek V4 haute performance hébergée sur la passerelle OpenCode.",
    ),
    "opencode:gemini-3.5-flash-lite": ModelSpec(
        provider="opencode",
        model_id="gemini-3.5-flash-lite",
        display_name="Google Gemini 3.5 Flash Lite (OpenCode)",
        context_window=1048576,
        max_tokens=65536,
        supports_vision=True,
        supports_thinking=False,
        ...
        completion_pricing=0.40,
        recommended_tasks=["flashcards", "vision", "long_docs", "batch"],
        ankiforge_use_case="Fenêtre géante de 1M tokens sur la passerelle OpenCode pour ingérer des cours massifs et des images.",
        description="Version Flash Lite de Google accessible via la passerelle OpenCode.",
    ),
    "opencode:gpt-5.4-mini": ModelSpec(
        provider="opencode",
        model_id="gpt-5.4-mini",
        display_name="GPT-5.4 Mini (OpenCode)",
        context_window=128000,
        max_tokens=16384,
        supports_vision=True,
        supports_thinking=False,
        ...
        is_free=False,
        prompt_pricing=0.25,
        completion_pricing=1.00,
        recommended_tasks=["flashcards", "audit"],
        ankiforge_use_case="Polyvalence et rigueur de la série GPT pour le découpage atomique et l'audit de cartes.",
        description="Modèle compact OpenAI de nouvelle génération sur la passerelle OpenCode.",
    ),
    "opencode:qwen3.8-flash": ModelSpec(
        provider="opencode",
        model_id="qwen3.8-flash",
        display_name="Qwen 3.8 Flash (OpenCode)",
        context_window=128000,
        max_tokens=16384,
        supports_vision=False,
        supports_thinking=False,
        ...
        recommended_tasks=["flashcards", "batch"],
        ankiforge_use_case="Modèle bilingue français/anglais ultra-rapide et économique pour la génération en masse.",
        description="Modèle Qwen optimisé pour la rapidité sur la passerelle OpenCode.",
    ),
    # ── OPENROUTER (Modèles Réellement Gratuits :free) ──
    "openrouter:qwen/qwen3.8-27b:free": ModelSpec(
        provider="openrouter",
        model_id="qwen/qwen3.8-27b:free",
        display_name="Qwen 3.8 27B (OpenRouter Gratuit)",
        ...
        completion_pricing=0.0,
        recommended_tasks=["flashcards", "batch", "audit"],
        ankiforge_use_case="Le meilleur modèle 100% gratuit sur OpenRouter : bilinguisme impeccable et respect parfait des consignes JSON.",
        description="Modèle 27B d'Alibaba accessible sans frais avec une clé OpenRouter.",
    ),
    "openrouter:google/gemma-4-31b-it:free": ModelSpec(
        provider="openrouter",
        model_id="google/gemma-4-31b-it:free",
        display_name="Google Gemma 4 31B (OpenRouter Gratuit)",
        context_window=32768,
        max_tokens=8192,
        supports_vision=False,
        supports_thinking=False,
        ...
        completion_pricing=0.0,
        recommended_tasks=["flashcards", "audit"],
        ankiforge_use_case="Nouveau modèle ouvert de Google, précis et rigoureux pour formuler des cartes claires sans coût.",
        description="Dernière génération Gemma de Google en accès gratuit sur OpenRouter.",
    ),
    "openrouter:nvidia/nemotron-3.5-lightning:free": ModelSpec(
        provider="openrouter",
        model_id="nvidia/nemotron-3.5-lightning:free",
        display_name="Nemotron 3.5 Lightning (OpenRouter Gratuit)",
        context_window=128000,
        max_tokens=16384,
        supports_vision=False,
        supports_thinking=False,
        ...
        completion_pricing=0.0,
        recommended_tasks=["flashcards", "batch"],
        ankiforge_use_case="Inférence éclair avec grande fenêtre de contexte (128k) pour le traitement par lots gratuit.",
        description="Modèle accéléré de NVIDIA avec fenêtre 128k disponible gratuitement sur OpenRouter.",
    ),
}
